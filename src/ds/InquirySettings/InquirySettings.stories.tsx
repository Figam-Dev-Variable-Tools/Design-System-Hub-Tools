...
/**
 * Labels: 영문 오버라이드 — 탭·섹션 제목·설정 행·표 머리글·확인창까지 labels 통로 하나로 닿는다.
 * 톤 Select의 옵션 문구(Primary…)도 labels가 갖고 있어 함께 바뀐다.
 */
export const Labels: Story = {
  args: {
    labels: {
      ...
      types: {
        title: 'Inquiry types',
        description: 'Shown on the request form. Drag the handle or press Ctrl/Cmd + ↑ ↓ to reorder.',
        add: 'Add type',
        empty: 'No inquiry types yet.',
        emptyDescription: 'Add a type to build the request form.',
        enabled: 'On',
        disabled: 'Off',
      ...
      automation: {
        title: 'Automations',
        description: 'Runs right after an inquiry is received.',
        autoAssign: 'Auto-assign',
        autoAssignHint: 'Assign new inquiries by the routing rules.',
        autoReply: 'Auto-reply',
        autoReplyHint: 'Send the acknowledgement message right away.',
        faqSuggest: 'FAQ suggestions',
        faqSuggestHint: 'Offer similar FAQs to the customer first.',
        sla: 'SLA response target',
        slaHint: 'Aim to send the first reply within this window.',
        slaUnit: 'h',
      },
      templates: {
        title: 'Reply templates',
        description: 'Used by auto-replies and by agents.',
        add: 'Add template',
        empty: 'No reply templates yet.',
        commonType: 'All types',
      },
      columns: { title: 'Template', typeKey: 'Inquiry type', body: 'Body', updatedAt: 'Updated' },
      notification: {
        title: 'Notifications',
        description: 'Pick the channels and who receives them.',
        targetPlaceholder: 'Recipients',
        email: 'Email',
        emailHint: 'Sent when an inquiry is received and answered.',
        sms: 'SMS',
        smsHint: 'Sent when an inquiry is answered.',
        kakao: 'KakaoTalk',
        kakaoHint: 'Sent through an alert template.',
        admin: 'Admin alerts',
        adminHint: 'Tell admins about new inquiries and SLA risks.',
      },
      statusStyles: {
        title: 'Inquiry status badges',
        description: 'Edit the label and tone of each status. The preview on the right is live.',
        descriptionNoPreview: 'Edit the label and tone of each status.',
        key: 'Status key',
        label: 'Label',
        tone: 'Tone',
        preview: 'Preview',
      ...
      typeDialog: {
        create: 'Add inquiry type',
        edit: 'Edit inquiry type',
        delete: 'Delete this inquiry type?',
        deleteDescription: (label) => `'${label}' will be removed.`,
        name: 'Type name',
        namePlaceholder: 'e.g. Shipping',
        code: 'Key',
        codePlaceholder: 'Leave blank to generate',
        codeHint: 'Saved as an alphanumeric key.',
        codeHintReadonly: 'The key cannot be changed.',
        enabled: 'Show on the request form',
      },
      templateDialog: {
        create: 'Add reply template',
        edit: 'Edit reply template',
        delete: 'Delete this reply template?',
        deleteDescription: (title) => `'${title}' will be removed.`,
        name: 'Template name',
        namePlaceholder: 'e.g. Shipping delay notice',
        type: 'Inquiry type',
        body: 'Body',
        bodyPlaceholder: 'Write the reply that goes to the customer.',
      },
    },
  },
  render: (args) => <InquirySettingsDemo {...args} />,
